...
import temp1 from '../Photos/Home/temp1.jpg';
import temp2 from '../Photos/Home/temp2.avif';
import temp3 from '../Photos/Home/temp3.jpg';
import img2 from '../Photos/Home/img2.jpg';
import img3 from '../Photos/Home/img3.jpg';
import img4 from '../Photos/Home/img4.avif';
import img5 from '../Photos/Home/img5.jpg';
import img6 from '../Photos/Home/img6.avif';
import c1 from '../Photos/Home/c1.jpg';
import c2 from '../Photos/Home/c2.avif';
import c3 from '../Photos/Home/c3.jpg';
...
<header className="bg-dark py-2">
                        <div className="container px-4 px-lg-5 my-5" >
                            <div className="text-center text-white">
                                <h1 className="display-4 fw-bolder">TO Access Our Shop you need To Login First </h1>
                            </div>
                        </div>
                    </header>
        ...
        <main className="bg-dark text-light" >
          ...
          <div class="row featurette" style={{ marginLeft: '10px', marginRight: '10px' }}>
            <div class="col-md-7">
          ...
          <div class="row featurette" style={{ marginLeft: '10px', marginRight: '10px' }}>
            <div class="col-md-7">
              <h2 class="featurette-heading">And lastly, this one. <span class="text-muted text-light">Checkmate.</span></h2>
          ...
          <div class="container marketing mt-5 ">
            <div class="row">
              <div class="col-lg-3" style={{ marginLeft: '70px' }}>
                <img
