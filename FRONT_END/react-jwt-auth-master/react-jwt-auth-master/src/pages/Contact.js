...
class Contact extends React.Component {
    ...
    handleSubmit = (event) => {
        ...
        // You can send form data to your backend here using fetch or Axios
                                        ...
                                        <div className="row gy-4 gy-xl-5 p-4 p-xl-5">
                                            ...
                                            <div className="col-12 col-md-6">
                                                ...
                                                <div className="input-group">
                                                    ...
                                                    <input type="tel" className="form-control" id="phone" name="phoneNumber" value={this.state.phoneNumber} onChange={this.handleChange} />
                                                </div>
                                            </div>
                                            <div className="col-12">
                                            ...
                                            <div className="col-12">
                                                <div className="d-grid">
                                                    <button className="btn btn-primary btn-lg text-dark" type="submit">Submit</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
