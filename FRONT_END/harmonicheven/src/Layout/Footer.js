...
function Footer() {
  return (
    <>
      ...
      <footer className="text-center text-lg-start text-white" style={{ backgroundColor: '#212529' }}>
        <section className="d-flex justify-content-between p-1" style={{ backgroundColor: '#212529' }}>
          <div className="me-5">
